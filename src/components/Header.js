    ...
    <header className="sticky top-0 z-50 bg-[#0F2A22]/95 backdrop-blur-sm border-b border-[#D4AF7A]/20">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 flex items-center justify-between h-20">
        ...
        <div className="hidden md:block">
          <button
            onClick={callfinalfunction}
            className="border border-[#D4AF7A] text-[#D4AF7A] text-sm font-semibold tracking-wide px-6 py-2.5 rounded-sm transition-colors duration-200 hover:bg-[#D4AF7A] hover:text-[#0F2A22]"
          >
        ...
        >
          <span
            className={`block h-px w-6 bg-[#F3EFE6] transition-transform duration-200 ${
              menuOpen ? "translate-y-1.5 rotate-45" : ""
            }`}
          />
          <span
            className={`block h-px w-6 bg-[#F3EFE6] transition-opacity duration-200 ${
              menuOpen ? "opacity-0" : ""
            }`}
          />
          <span
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-[#D4AF7A]/20 bg-[#0F2A22] px-6 py-6">
          ...
          <button
            onClick={callfinalfunction}
            className="mt-6 w-full border border-[#D4AF7A] text-[#D4AF7A] text-sm font-semibold tracking-wide px-6 py-2.5 rounded-sm transition-colors duration-200 hover:bg-[#D4AF7A] hover:text-[#0F2A22]"
          >
            {jwttoken ? "Logout" : "Login"}
          </button>
        </div>
